...
class FaqController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return redirect()->route('admin_faq')->with('info', 'Sıkça Sorulan Soru Eklendi!');
    }
    ...
    public function update(Request $request, Faq $faq,$id)
    {
        ...
        $data->status= $request->input('status');
        $data->save();
        return redirect()->route('admin_faq')->with('info', 'Sıkça Sorulan Soru Güncellendi!');
    }
    ...
    public function destroy(Faq $faq,$id)
    {
        ...
        $data = Faq::find($id);
        $data->delete();
        return redirect()->route('admin_faq')->with('info', 'Sıkça Sorulan Soru Silindi!');
