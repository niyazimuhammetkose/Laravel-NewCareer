...
class JobController extends Controller
{
    ...
    {
        //
        $datalist = Job::where('user_id', Auth::id())->get();
        return view('home.user_profile_job', ['datalist' => $datalist]);
    }
    ...
    public function update(Request $request, Job $job,$id)
    {
        ...
        $data->save();
        return redirect()->route('user_jobs')->with('info', 'İş İlanı Güncellendi!');
    }
    ...
    public function destroy(Job $job,$id)
    {
        ...
        $data = Job::find($id);
        $data->delete();
        return redirect()->route('user_jobs')->with('info', 'İş İlanı Silindi!');
