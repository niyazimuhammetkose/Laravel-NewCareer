...
@section('title', 'Admin Panel - Sıkça Sorulan Soru Düzenleme')
                ...
                <div class="page-header">
                    <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
                        <ul class="quick-links ml-auto">
                            ...
                            <li>Sıkça Sorulan Soru Düzenleme</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" action="{{route('admin_faq_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-success btn-fw"><i class="mdi mdi-check"></i>Sıkça Sorulan Soru Güncelle</button>
